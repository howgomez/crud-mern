...
export const Dashboard = () => {
  ...
  const combinedTasks = [
    ...filteredTasks, // Tareas filtradas primero
    ...publicTasks.filter(task => !filteredTasks.includes(task)), // Tareas no coincidentes
  ];
      ...
      <div>
        <div className="flex flex-col items-center mt-10 gap-4 w-full sm:w-[60%] m-auto p-4">
          <input
            ...
            className="rounded-md text-md text-white outline-none p-2 w-full sm:w-[350px] bg-gray-800"
